...
<body>
    ...
    <div class="row text-center">
        <h3 class="text-start"><?php echo "Hai ", $_SESSION["user"]["name"]; ?></h3>

        <br>
        <br>

        <h2 style="margin-bottom:30px;" class="text-start">Keranjang Belanja</h2>
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                    ...
                    $total+=$sub_total;
                ?>
                <input type="hidden" name="kode_produk[]" class="kode_produk"
                ...
                <tr>
                    ...
                    <td>
                        <form method="get">
                            <input type="hidden" name="kode_produk" value="<?php echo $item['kode_produk']; ?>"
                                class="form-control">
                        ...
                        <a href="mainpage.php?halaman=keranjang-belanja&kode_produk=<?php echo $item['kode_produk']; ?>&aksi=hapus"
        ...
        <br>
        <br>
        <p><a href="mainpage.php" class="btn btn-dark btn-block">Tambah Item</a></p>
        <br>
        <br>
        <p><a href="payment.html" class="btn btn-dark btn-block">Lanjut Bayar</a></p>
        <br>
        <br>
    </div>
